...
<body>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarColor03">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    <li class="nav-item">
                        <a class="nav-link active" aria-current="page">Tabla Eventos</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="tablaCliente.php">Tabla Clientes</a>
                    </li>
                    <li class="nav-item">
    ...
    <div class="" style="padding: 20px 50px 0px 50px;">
        <div class="">
            ...
            <table id="example" class="table table table-borderless" style="width:100%;">
                <thead>
                    <tr>
                        <th>Nº</th>
                        <th>Cliente</th>
